  ...
  const mockRecommendations = [
    {
      ...
      description: "World-renowned sushi restaurant with innovative fusion cuisine",
      rating: 4.8,
    ...
    },
    {
      ...
      type: "Food Market",
      description: "Historic fish market with authentic street food and fresh seafood",
      rating: 4.6,
    ...
    },
    {
      ...
      description: "Futuristic dinner show with robots, lasers, and Japanese pop culture",
      rating: 4.2,
...
async function generateItinerary(affinities: any[], destination: string, duration: string) {
        ...
        activities: [
          {
            ...
            location: "Chuo City, Tokyo",
            duration: "2 hours",
            description: "Start your day with fresh sushi and traditional Japanese breakfast at the famous fish market",
          },
          {
            time: "12:00 PM",
            ...
            duration: "3 hours",
            description: "Immersive digital art experience that combines technology with creativity",
          },
          {
            time: "7:00 PM",
            name: "Nobu Tokyo",
            ...
            location: "Minato City, Tokyo",
            duration: "2 hours",
            description: "World-class Japanese fusion cuisine in an elegant setting",
          },
        ],
      },
      {
        ...
        activities: [
          {
            ...
            duration: "2 hours",
            description: "Tokyo's oldest temple with traditional architecture and spiritual significance",
          },
          {
            time: "2:00 PM",
            ...
            duration: "3 hours",
            description: "Explore youth culture, fashion, and unique street art in Tokyo's most vibrant district",
          },
          {
            time: "8:00 PM",
            name: "Robot Restaurant",
            ...
            location: "Shinjuku, Tokyo",
            duration: "2 hours",
            description: "Futuristic dinner show combining robots, music, and Japanese pop culture",
          },
        ],
      },
    ],
...
export async function POST(request: NextRequest) {
  try {
    ...
    const affinityContext = affinities.map((a) => `${a.type}: ${a.id}`).join(", ")

    if (!OPENAI_API_KEY) {
      return NextResponse.json(
        {
          error: "Missing OPENAI_API_KEY. Set it in your Vercel / local env (e.g. `.env.local`).",
        },
        { status: 500 },
      )
    }
...
${JSON.stringify(recommendations, null, 2)}`,
    ...
    if (isItineraryQuery) {
      ...
      const itinerary = await generateItinerary(affinities, destination, duration)
