...
import { Star, MapPin, Heart, Share, ExternalLink } from "lucide-react"
...
export function RecommendationCard({ recommendation }: RecommendationCardProps) {
  ...
  const handleLike = () => {
    setIsLiked(!isLiked)
    // Here you would typically send this preference to your backend
  }
        ...
        {recommendation.imageUrl ? (
          ...
          <div className="w-full h-full flex items-center justify-center">
            <div className="text-center">
              ...
              <div className="text-sm text-muted-foreground">{recommendation.type}</div>
            </div>
          </div>
        )}
        ...
        <div className="flex justify-between items-start mb-2">
          ...
          <div className="flex items-center space-x-1">
            <Button
              ...
              size="icon"
              onClick={handleLike}
              className={`h-8 w-8 ${isLiked ? "text-red-500" : "text-gray-400"}`}
            >
